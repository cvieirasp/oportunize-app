      ...
      <TooltipProvider>
        <div className="flex flex-wrap gap-1">
          ...
          <Tooltip>
            ...
            <TooltipContent>Rsicado</TooltipContent>
          </Tooltip>
        ...
        <div className="flex flex-wrap gap-1">
          <Tooltip>
            ...
            <TooltipContent>Cabeçalho 1</TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>Cabeçalho 2</TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>Cabeçalho 3</TooltipContent>
          </Tooltip>
        </div>
        ...
        <div className="flex flex-wrap gap-1">
          <Tooltip>
            ...
            <TooltipContent>Alinhamento para Esquerda</TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>Alinhamento Central</TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent>Alinhamento para Direita</TooltipContent>
          </Tooltip>
        </div>
